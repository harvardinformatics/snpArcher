...
set.colors <- c('#a6cee3','#1f78b4','#33a02c','#fb9a99','#e31a1c','#fdbf6f','#ff7f00','#cab2d6','#6a3d9a')
...
# This interactive code really should work but when rendered with plotly, in the pipeline, the tree is blank
...
Row {data-width=1200, data-height=1600}
-----------------------------------------------------------------------

### Map

```{r, fig.width = 10, height = 10}
