...
rule gatherVcfs:
    ...
    shell:
        ...
        "--filter-expression \"(vc.isSNP() && ((vc.hasAttribute('FS') && FS > 60.0) || ((vc.isIndel() || vc.isMixed()) && ((vc.hasAttribute('FS') && FS > 200.0) || (vc.hasAttribute('SOR') &&  SOR > 10.0)))\" "
        "--filter-name \"MQ_filter\" "
        "--filter-expression \"vc.isSNP() && ((vc.hasAttribute('MQ') && MQ < 40.0) || (vc.hasAttribute('MQRankSum') && MQRankSum < -12.5))\" "  
        "--filter-expression \"(vc.hasAttribute('QD') && QD < 2.0) || ((vc.isIndel()\" "
        "--filter-name \"QD_filter\" "
        "--filter-expression \"(vc.isSNP() && ((vc.hasAttribute('SOR') && SOR > 3.0) || ((vc.isIndel()\" "
